      ...
      <Container>
        <Row className="justify-content-center">
          <Col xs={12} sm={10} md={9} className="text-center pb-3 pb-md-4">
            <h2> أقل من القيام. المزيد للاستمتاع.</h2>
            <p className="fw-medium">
              في <strong>أخدمنى</strong>، نؤمن أن منزلك يجب أن يكون مكانًا
              للراحة، لا مصدر للقلق. هذا هو السبب فيما نفعل - بحيث يمكنك العودة
              إلى المنزل للحياة التي عملت بجد لتبنيه، و الاستمتاع بها.
            </p>
          </Col>
        </Row>
